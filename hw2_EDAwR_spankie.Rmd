...
## ANSWER: There are NA values in the following variables for county_df: "Income" "IncomeErr" "ChildPoverty". There are no NA values in county_df.
##         The dataframe county_MI has 41 variables, while county_df only has 40 variables. Because county_MI only contains observations from Michigan,
##         the variable "peninsula" was added to specify if the observation was from the lower peninsula or the upper peninsula. Another difference between
##         the two structures is that county_MI has less levels in its factor variables because there are less observations in this data frame.
