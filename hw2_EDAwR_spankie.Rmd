...
*One might want to use a log scale or a log transform when the data they are working with is non-negative and is skewed. Skewed data makes seeing and comparing the relationship between two variables difficult. By scaling/transforming the data, the distribution becomes more normally distributed.*
