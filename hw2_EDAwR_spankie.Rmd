...
ggplot(county_df, aes(x = county_df$Division, y = county_df$Income)) + 
  geom_boxplot(col = "black", 
               fill = "green") + 
  labs(title = "US Median County Income by Division", 
       x = "Division", 
...
ggplot(county_df, aes(county_df$Income, fill = county_df$Region)) + 
  geom_density(position = "stack", 
               alpha = .4) + 
  labs(title = "US Median County Income by Region", 
       x = "Median Income", 
       y = "Density", 
       fill = "Region") + 
...
*The distributions do differ with respect to distribution of median income over the counties. The lower peninsula has a much wider spread of median income and has a higher mean median income.*
...
*The first boxplot below compares the percentage of the population in each UP and LP county that are men. In the LP, the percentage of men in each county ranges mostly from 48% to 52% with a couple outliers around 53%. The UP, on the other hand, ranges from about 49% to over 60%.*
